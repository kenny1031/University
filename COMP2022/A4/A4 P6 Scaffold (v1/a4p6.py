...
def part1(history):
    ...
    if len(history) == 0: #If there were no prior questions (i.e. this is the first question)...
        return (1,Atom("r")) #Ask guard 1 if r is true
    answer = history[0][2] #Otherwise (there was a prior question), look at guard 1's answer
